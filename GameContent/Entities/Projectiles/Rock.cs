...
namespace MiniJam61Egypt.GameContent.Entities.Projectiles
{
    public class Rock : Projectile
    {
        ...
        public Rock(Vector2 p, Vector2 v, Vector2 size) : base(p, v, size)
        {
        ...
        public override void Draw(ExtendedSpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Main.RockTexture, Body.Center, null, Color.White, Rotation, Main.RockTexture.Bounds.Size.ToVector2() * 0.5f, 1f, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0f);
        }
    }
}
