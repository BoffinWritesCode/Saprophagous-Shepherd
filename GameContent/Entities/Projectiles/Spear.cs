...
namespace MiniJam61Egypt.GameContent.Entities.Projectiles
{
    public class Spear : Projectile
    {
        ...
        public Spear(Vector2 p, Vector2 v, Vector2 size) : base(p, v, size)
        {
        ...
        public override void Draw(ExtendedSpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Main.WeaponTextures[2], Body.Center, null, Color.White, Rotation, Main.RockTexture.Bounds.Size.ToVector2() * 0.5f, 1f, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0f);
        }
    }
}
